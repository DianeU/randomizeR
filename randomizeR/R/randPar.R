...
#' of randomization sequences for the given parameters. If \code{N} of the
#' underlying object of class \linkS4class{randPar }is a vector the output will instead
#' be an wrapper object of class \linkS4class{randSeqs}. The output consists of the
#' parameters used for the generation of the randomization sequences (see \code{\link{createParam}})
#' and the matrix \code{M} that stores the randomization sequences in its rows. 
#' 
...
#' getAllSeq(myPar)
#' 
#' # all randomization sequences of two strata of Complete Randomization with N = 10 and 8
#' myPar <- crPar(c(10, 8))
#' getAllSeq(myPar)
#' 
...
#' If \code{r} is missing, one sequence is generated by default. If \code{N} of the
#' underlying object of class \linkS4class{randPar} is a vector the output will instead
#' be an wrapper object of class \linkS4class{randSeqs}.
#' 
#' @examples
...
#' genSeq(myPar)
#' 
#' # generate randomization sequences of two strata of Complete Randomization with N = 10 and 8
#' myPar <- crPar(c(10, 8))
#' genSeq(myPar)
#' 
