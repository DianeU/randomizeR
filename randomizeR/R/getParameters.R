...
#'
#' @examples
#' # return the new shape and scale parameters of an weibull distribution, when underlying selection bias
#' endp <- weibEndp(shape = c(1,1) , scale = c(0.5,1), c = c(1,1),
#'  exp = c(0,0), weights = c(0,0) , cenTime = 10, cenRate = 0.01)
