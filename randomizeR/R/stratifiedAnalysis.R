...
#' @examples
#' Create and Compare stratified sequences for 80 patients with the randomization procedures Big Stick Design with maximum tolerated imbalance of 9, Complete Randomization(CR), Efrons Biased Coin design with probability p = 0.67 and Permuted Block design with blocksizes of 4.
#' The patients are distributed according to a 1 to 3 allocaiton ratio in 2 strata.
#' analyse(N = 80, endp = normEndp(c(0,0),c(1,1)), allocRatio = c(1,3),strata = 2, theta = 0, eta = 0.05, pr = c("BSD(9)","CR","EBC(0.67)","PBR(4)"))
#'
#' @return
