...
build(pkg="C:\\Users\\Marcia\\GitLab\\randomizeR\\randomizeR")
devtools::release_checks(current.code)
#validate_email(email = "Diane.Uschner@gmail.com", token = "cce2a98051a3445c8518223f6a00110b")
#check_rhub(current.code) # check on R-Hub
#check_win_devel(current.code, email="mrueckbeil@ukaachen.de")# Check win-builder
